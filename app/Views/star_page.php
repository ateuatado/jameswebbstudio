        ...
        <form id="checkoutForm">
          ...
          <div style="display:flex;gap:10px;margin-bottom:12px;">
            ...
            <div style="flex:1;">
              ...
              <input type="text" name="address" id="heroAddr" placeholder="Rua, Av, Alameda..." style="width:100%;background:#000;border:1px solid rgba(255,255,255,.12);color:#fff;padding:12px 16px;font-size:.95rem;outline:none;">
            </div>
          </div>
          <div style="display:flex;gap:10px;margin-bottom:12px;">
            <div style="flex:0 0 120px;">
              ...
              <input type="text" name="address_number" id="heroNum" placeholder="123" style="width:100%;background:#000;border:1px solid rgba(255,255,255,.12);color:#fff;padding:12px 16px;font-size:.95rem;outline:none;">
            </div>
            <div style="flex:1;">
              ...
              <input type="text" name="address_complement" id="heroComp" placeholder="Apto, Bloco, Casa..." style="width:100%;background:#000;border:1px solid rgba(255,255,255,.12);color:#fff;padding:12px 16px;font-size:.95rem;outline:none;">
            </div>
          </div>
          ...
          <div style="margin-bottom:20px;" id="spImageUsageWrapper">
            <label style="display:flex;align-items:flex-start;gap:10px;cursor:pointer;font-family:'Inter',sans-serif;font-size:.78rem;color:rgba(255,255,255,.55);line-height:1.5;">
              <input type="checkbox" name="image_usage" id="chk_image_usage" value="1" style="margin-top:3px;accent-color:#C5A059;min-width:16px;">
              Autorizo o uso das minhas imagens para portfólio e divulgação do fotógrafo.
            </label>
            <div id="spImageUsageNotice" style="display:none;margin-top:8px;padding:10px 14px;background:rgba(197,160,89,.08);border:1px solid rgba(197,160,89,.3);border-radius:3px;font-family:'Inter',sans-serif;font-size:.72rem;color:rgba(197,160,89,.85);line-height:1.6;">
...
<script>
    ...
    function openCheckout(pkgId, pkgName, price, heroId) {
        ...
        if (_activeCoupon && _activeCoupon.free) {
            ...
            // Marca e bloqueia o checkbox de cessão de imagem
    ...
    function enforceImageUsageForFree(enforce) {
        const chk     = document.getElementById('chk_image_usage');
        const notice  = document.getElementById('spImageUsageNotice');
        const wrapper = document.getElementById('spImageUsageWrapper');
        if (!chk) return;
        if (enforce) {
            chk.checked  = true;
